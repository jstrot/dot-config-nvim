...
return {
  {
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>tlv',  '<Plug>(toggle-lsp-diag-vtext)',            { desc = '[T]oggle [L]sp diagnostics [V]igns' })
      ...
      vim.keymap.set('n', '<leader>tldo', '<Plug>(toggle-lsp-diag-on)',               { desc = '[T]oggle all [L]sp diagnostics on' })
      vim.keymap.set('n', '<leader>tldf', '<Plug>(toggle-lsp-diag-off)',              { desc = '[T]oggle all [L]sp diagnostics off' })
    end,
  }
}
