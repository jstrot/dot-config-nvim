-- Enable individual LSPs here.
--
-- - If the nvim-lspconfig plugin is enabled, primary configuration files are
--   located in ~/.local/share/nvim/lazy/nvim-lspconfig/lsp/ .
-- - Additional LSP configuration files can be added to your own
--   ~/.config/nvim/lsp/ directory. Note that this directory has lower priority
--   than nvim-lspconfig's.
-- - Configuration overrides should be created in your
--   ~/.config/nvim/after/lsp/ directory.
--
-- Note that this file is loaded after plugins are initialized while above
-- configurations are always available to Neovim and plugins.
--
-- Other configurations related to LSPs:
-- - To have a basic set of LSPs installed everywhere you go, see
--   `lsp_ensure_installed` config in lua/plugins/mason.lua
...
--[[ AI ]]
require('config.ai')
if vim.g.auto_suggest_completion_plugin == 'copilot-native-lsp' then
...
vim.api.nvim_create_autocmd('LspAttach', {
  -- TODO: Disable LSP on /tmp buffers?
